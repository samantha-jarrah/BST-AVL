...
class AVL(BST):
    ...
    def remove(self, value: object) -> bool:
        """
        Removes the node with the passed value from the AVL tree
        Returns False if the tree is empty or the value is not present, Returns True otherwise
        Handles all necessary rotations for rebalancing
        Time Complexity: O(log n)
        """
